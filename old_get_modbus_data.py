...
def save_modbus():
        ...
        while True:                                         
                ...
                try:        
                    a_x = template_modbus(port, 9, 9600, 8, 1, 0.8, 154, 2, 4, 'float')
                    a_y = template_modbus(port, 9, 9600, 8, 1, 0.8, 174, 2, 4, 'float')
                    a_z = template_modbus(port, 9, 9600, 8, 1, 0.8, 194, 2, 4, 'float')                
                except:                                 
                    a_x = 0                 
                    a_y = 0
                    a_z = 0  
                ...
                try:                    
                    v_x = template_modbus(port, 9, 9600, 8, 1, 0.8, 214, 2, 4, 'float')
                    v_y = template_modbus(port, 9, 9600, 8, 1, 0.8, 234, 2, 4, 'float')
                    v_z = template_modbus(port, 9, 9600, 8, 1, 0.8, 254, 2, 4, 'float')               
                except:
                    v_x = 0                 
                    v_y = 0
                    v_z = 0                 
                ...
                try:        
                    x = template_modbus(port, 9, 9600, 8, 1, 0.8, 274, 2, 4, 'int')
                    y = template_modbus(port, 9, 9600, 8, 1, 0.8, 294, 2, 4, 'int')
                    z = template_modbus(port, 9, 9600, 8, 1, 0.8, 314, 2, 4, 'int')            
                except: 
                    x = 0                   
                    y = 0
                    z = 0                           
                ...
                try:
                    cntr_1 = template_modbus(port, 59, 9600, 8, 1, 0.8, 1, 1, 4, 'int')
                    cntr_2 = template_modbus(port, 62, 9600, 8, 1, 0.8, 1, 1, 4, 'int')
                    cntr_3 = template_modbus(port, 67, 9600, 8, 1, 0.8, 1, 1, 4, 'int')                                                                               
                except:             
                    cntr_1 = 0                  
                    cntr_2 = 0
                    cntr_3 = 0
