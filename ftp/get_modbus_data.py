...
def save_modbus():
		...
		while True:
			...
			try:
				...
				r_data1 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0000, 0, 4, False)
				r_data2 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0001, 0, 4, False)
				r_data3 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0002, 0, 4, False)
				r_data4 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0003, 0, 4, False)
				r_data5 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0004, 0, 4, False)
				r_data6 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0005, 0, 4, False)
				r_data7 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0006, 0, 4, False)
				r_data8 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0007, 0, 4, False)
				r_data9 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0010, 0, 4, False)
				r_data10 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0011, 0, 4, False)
				r_data11 = template_modbus('/dev/ttyUSB3', 1, 115200, 8, 1, 0.1, 0012, 0, 4, False)
